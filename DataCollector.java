...
public class DataCollector
{
  ...
  public void socialMediaPosts(ArrayList<String> socialMediaPosts) {
  ...
  public void targetWords(ArrayList<String> targetWords) {
   ...
   * space
   * 
   * @param socialMediaPostsFilename socialMediaPosts.txt
   * @param targetWordsFilename targetWords.txt
   */
